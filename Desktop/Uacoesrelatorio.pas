...
begin
  MessageDlg('Você tem certeza que deseja excluir esse relatório ?', System.UITypes.TMsgDlgType.mtInformation,
    [
    ...
    begin
       // ShowMessage('Seu relatório sera excluido do banco local, mais não do seu computador !');
        mostraMensagem('Seu relatório sera excluido do banco local, mais não do seu computador !', 'Seu relatório sera excluido do banco local, mais não do seu computador !', 'OK');
        ...
        mostraMensagem('Excluido !', 'Excluido !', 'OK');
    end
    else
    begin
