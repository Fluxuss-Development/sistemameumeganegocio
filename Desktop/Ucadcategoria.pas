...
begin
  ...
  try
    ...
    notificacao.Title := 'Alteração de nova categoria';
...
begin
  if(edtnomecat.Text.Equals('') or edtdesccat.Text.Equals('')) then
  begin
    //ShowMessage('Os campos estão vazios preencha e tente novamente !');
    mostraMensagem('Os campos estão vazios preencha e tente novamente !', 'Os campos estão vazios preencha e tente novamente !', 'OK');
  end
  else
  begin
  try
    ...
    begin
     // ShowMessage('Ocorreu um erro ao criar a nova categoria tente novamente mais tarde !');
      ...
      //ShowMessage('Ocorreu um erro ao inserir suas informações no seu banco de dados !');
      mostraMensagem('Ocorreu um erro ao criar a nova categoria tente novamente mais tarde !', 'Ocorreu um erro ao criar a nova categoria tente novamente mais tarde !', 'OK');
  end;
  end;
end;
