...
//  ShowMessage('Campos em branco, certifique-se de preenchar todos os campos !');
  ...
  begin
   // ShowMessage('Fornecedor cadastrado com sucesso !');
    mostraMensagem('Fornecedor cadastrado com sucesso !', 'Fornecedor cadastrado com sucesso !', 'OK');
    edtnomefor.Text := '';
    edtendfor.Text := '';
    edttelefonefor.Text := '';
    edtcelular.Text := '';
  ...
  begin
   // ShowMessage('Ocorreu um erro ao inserir o fornecedor !');
    mostraMensagem('Ocorreu um erro ao inserir o fornecedor !', 'Ocorreu um erro ao inserir o fornecedor !', 'OK');
  end;
