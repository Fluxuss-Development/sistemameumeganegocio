...
type
  ...
  public
    { Public declarations }
    //variáveis publicas para verificar
...
begin
   ...
   // ShowMessage('Subcategoria alterada com sucesso !');
    ...
    try
       ...
       notificacao.Title := 'Alteração de uma subcategoria';
...
begin
  try
    ...
    begin
     // ShowMessage('Não foi possivel cadastrar sua subcatgeoria !');
      mostraMensagem('Não foi possivel cadastrar sua subcatgeoria !', 'Não foi possivel cadastrar sua subcatgeoria !', 'OK');
    end;
  except
