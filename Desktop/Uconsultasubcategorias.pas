...
begin
  ...
  dm.consultasubcategoria.SQL.Text := 'select * from subcategoria where subcatativa = 1 and subcatnome like ' + QuotedStr(edtbuscar.Text + '%');
  dm.consultasubcategoria.Active := true;
end;

procedure Tfrmconsultasubcategoria.edtbuscarKeyDown(Sender: TObject;
...
procedure Tfrmconsultasubcategoria.FormShow(Sender: TObject);
begin
...
frmcadsubcategoria.subcatcod := dm.consultasubcategoriasubcatcod.AsInteger; //id da subcategoria para usar no where
frmcadsubcategoria.edtsubcatdesc.Text := dm.consultasubcategoriasubcatdescricao.AsString;
frmcadsubcategoria.iddacategoria := dm.consultasubcategoriacatid.AsInteger; //pega o id da categoria pai
