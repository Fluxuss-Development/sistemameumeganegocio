...
begin
dm.viewexibedetalhesvendas.Close;                      //pega somente as vendas que renderão algum valor ou seja foram finalizadas
...
procedure Tfrmconsultarvendas.lsconsultavendaItemClickEx(const Sender: TObject;
  ItemIndex: Integer; const LocalClickPos: TPointF;
  const ItemObject: TListItemDrawable);
//variável para cacatenar os métodos de pagamento
var
metodospagamento : string;
begin
dm.viewexibedetalhesvendas.RecNo := lsconsultavenda.Selected.Index + 1;
frmdetalhesdavenda.lblcodigodavenda.Text := 'Código da venda: ' + dm.viewexibedetalhesvendasvencod.AsString;
...
frmdetalhesdavenda.lblcodigocaixa.Text := 'Código do caixa: ' + dm.viewexibedetalhesvendasvencaicod.AsString;
frmdetalhesdavenda.lblmetodopag.Text := 'Método de pagamento dessa venda: ';
//rotina que vai percorrer tudo e trazer todos os métodos de pagamentos
