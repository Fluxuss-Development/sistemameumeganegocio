...
//verifica para não desativar o acesso da pessoa logada
...
begin
 // ShowMessage('Você não pode desativar seu próprio acesso, tente a partir de outro usuário !');
  mostraMensagem('Você não pode desativar seu próprio acesso, tente a partir de outro usuário !', 'Você não pode desativar seu próprio acesso, tente a partir de outro usuário !', 'OK');
  abort;
end;
//senão
...
mostraMensagem('Acesso de funcionário desativado com sucesso ::: ' + dm.consulta_funcio_auditoriaempnome.AsString, 'Acesso de funcionário desativado com sucesso ::: ' + dm.consulta_funcio_auditoriaempnome.AsString, 'OK');
dm.consulta_funcio_auditoria.Close;
dm.consulta_funcio_auditoria.Open;
end;
