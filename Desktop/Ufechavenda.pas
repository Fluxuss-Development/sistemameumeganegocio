...
begin
//caso a venda seja efetuada aqui quando abrir o form novamente para outra venda, a variável desconto vai ser zerada !
desconto := 0;
end;
...
try
  begin
   ...
   mostraMensagem('Método de pagamento removido', 'Método de pagamento removido', 'OK');
   dm.consultapagamentos.Close;
   dm.consultapagamentos.Open();
  end;
except
