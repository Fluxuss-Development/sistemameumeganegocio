...
begin
  ...
  // ShowMessage('Cupom gerado com sucesso, escolha um programa para abri-lo');
   mostraMensagem('Cupom gerado com sucesso, escolha um programa para abri-lo', 'Cupom gerado com sucesso, escolha um programa para abri-lo', 'OK');
   end;
