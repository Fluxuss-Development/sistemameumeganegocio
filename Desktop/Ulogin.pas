  ...
  try
    ...
    begin
      ...
      begin
        ...
        id_do_usuario_logado := dm.qloginempcod.AsString;
...
try
   ...
   dm.meumeganegocio.Connected := true;
    ...
    mostraMensagem('Não foi possível conectar com o banco remoto !', 'Não foi possível conectar com o banco remoto !', 'OK');
    Application.Terminate;
end;
end;
